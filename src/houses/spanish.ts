...
import { IBalconySettings } from "./balconies";
import { IAwningSettings } from "./awnings";
...
const roof = {
  width: 10, // Example width of the roof
  depth: 10, // Example depth of the roof
  height: 2, // Example height from base to peak
  slope: 30, // Slope angle in degrees, if applicable
  material: new THREE.MeshStandardMaterial({ color: 0x8B4513 }), // Example roof material
  position: {
    x: 0, // Positioning the roof relative to the house's centroid or specific coordinates
    y: 30, // Example, placing the roof 3 units above the new floor's height
    z: 0,
  },
};

// Assuming your house structure can hold roofs similar to floors
house.roof = roof;
